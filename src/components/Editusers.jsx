      ...
      <div className="card-text">
        ...
        <div className="input-group mb-3">
          ...
          <input type="text" id="users_fullname" name="users_fullname" placeholder="fullname" value={
              this.state.edituser.users_fullname} onChange={ this.users_fullname_Change } className="form-control from-control-lg" />
        </div>
        ...
        <div className="input-group mb-3">
          ...
          <input type="text" id="users_phone" name="users_phone" placeholder="Userphone" value={
              this.state.edituser.users_phone} onChange={ this.users_phone_Change } className="form-control from-control-lg" />
        </div>
        ...
        <div className="input-group mb-3">
          ...
          <input type="text" id="users_email" name="users_email" placeholder="Useremail" value={
              this.state.edituser.users_email} onChange={ this.users_email_Change } className="form-control from-control-lg" />
        </div>


        <input type="submit" id="save_bt" name="save_bt" value="Save" className="btn btn-success  btn-lg col-md-5 mx-auto" />
       
        <input type="submit" id="cancel_bt" name="cancel_bt" value="Cancel" className="btn btn-lg  col-md-5 mx-auto" />
